...
if __name__ == "__main__":
    ...
    for i in range(10000, 20640):  # X.shape[1] gives the number of columns (features)
    ...
    csv_file = '../dataset/ipc_cycles_dataset/ML_model_ipc_cycles_dataset_10 iterations_avg.csv'  # Specify your CSV file name
