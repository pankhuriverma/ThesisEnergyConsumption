...
if __name__ == "__main__":
    ...
    for i in range(10000, 20460):  # X.shape[1] gives the number of columns (features)
                ...
                cyc, cpu_ene, dram_ene, total_ene = measure_model_perf_energy(X_train, y_train)
    ...
    csv_file = '../dataset/cycles_dataset/ML_model_cycles_dataset_joules_avg.csv'  # Specify your CSV file name
